...
<<<<<<< HEAD:sql/catalyst/src/main/scala/org/apache/spark/sql/catalyst/expressions/ScalaUdf.scala
  override def eval(input: Row): Any = converter(f(input))

=======
  override def eval(input: InternalRow): Any = converter(f(input))
>>>>>>> 4399b7b0903d830313ab7e69731c11d587ae567c:sql/catalyst/src/main/scala/org/apache/spark/sql/catalyst/expressions/ScalaUDF.scala
}
